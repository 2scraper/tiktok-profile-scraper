...
# `user_unavailable` is in this set, and it has to be. It describes a run
# that ASKED and got a real answer — TikTok returned no account for the
# handle — so the honest code for a zero-row run is 4 ("we asked, and the
# answer was nothing") and not 5 ("we never got the content").
#
