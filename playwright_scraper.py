#!/usr/bin/env python3
"""playwright_scraper.py — TikTok account statistics.

    python3 playwright_scraper.py --url "https://www.tiktok.com/@nasa"
    python3 playwright_scraper.py --url nasa,khaby.lame,zachking --concurrency 3
    python3 playwright_scraper.py --url @charlidamelio --format both --dump-html
